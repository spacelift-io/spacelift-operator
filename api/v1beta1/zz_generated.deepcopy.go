...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StackSpace) DeepCopyInto(out *StackSpace) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StackSpace.
func (in *StackSpace) DeepCopy() *StackSpace {
	if in == nil {
		return nil
	}
	out := new(StackSpace)
